...
bool	bFullScreen=TRUE;	// Fullscreen Flag Set To Fullscreen Mode By Default
int		xDelta;
int		yDelta;
int		xPos,xOldPos;
int		yPos,yOldPos;
bool	bCaptureModeOn=false;
...
BOOL CreateGLWindow(char* title, int width, int height, int bits, bool fullscreenflag)
{
	...
	bFullScreen=fullscreenflag;			// Set The Global Fullscreen Flag
